...
GLuint positionBuffer, positionBuffer1, colorBuffer, indexBuffer, indexBuffer1, vertexArrayObject, vertexArrayObject1, texBuffer,texBuffer1;
...
void initGL()
{
	...
	glGenBuffers(1, &texBuffer1);
	glBindBuffer(GL_ARRAY_BUFFER, texBuffer1);
	...
	switch(mag) {
		case 0: glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
			break;
		case 1: glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
			break;
	}
